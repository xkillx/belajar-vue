new Vue({
  ...
  methods: {
    ...
    fetchEvents: function() {
      this.$http.get('events').then(function(res) {
    ...
    addEvent: function() {
      ...
      if (this.edit) {
        this.$http.put('events/' + this.event.id, this.event).then(function(res) {
          this.fetchEvents();
          this.clear();
        }, function(error) {
          console.log(error);
        ...
        this.$http.post('events', this.event).then(function(res) {
          this.fetchEvents();
          this.clear();
        }, function(error) {
          console.log(error);
    ...
    deleteEvent: function(event, index) {
      if(confirm("Are you sure you want to delete this event?")) {
          this.$http.delete('events/' + event.id).then(function(res) {
          this.fetchEvents();
          this.clear();
        }, function(error) {
          console.log(error);
